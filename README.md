...
- Логирование в коде, с уровнями debug, info, warn, critical, error   (РЕАЛ.)
- Команда /stop, которая завершает работу приложения, используя механизм graceful offload: сессии удаляются с заданной скоростью, происходит запись CDR.  (РЕАЛ.)
